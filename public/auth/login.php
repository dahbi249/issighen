...
<body class="auth-page">
    ...
    <div class="auth-container">
            ...
            <form action="login_process.php" method="POST" id="loginForm" novalidate>
                ...
                <div class="form-group">
                    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:6px;">
                        ...
                        <a href="forgot_password.php?lang=<?= $lang ?>" style="font-size:.82rem;color:var(--text-light);"><?= htmlspecialchars($t['login_forgot']) ?></a>
                    </div>
                    <div class="input-group">
        ...
        <div style="text-align:center;margin-top:14px;padding-bottom:8px;">
            <a href="../../" style="color:rgba(255,255,255,.65);font-size:.84rem;">
