    ...
    <section class="hero">
        ...
        <div class="container">
            <div class="hero-content">
                ...
                <form class="hero-search" action="offers.php" method="GET">
                ...
                <div class="hero-buttons">
                    <a href="offers.php?lang=<?= $lang ?>" class="btn btn-primary btn-lg">
                        <i class="fas fa-compass"></i> <?= htmlspecialchars($t['hero_cta']) ?>
                    </a>
                    <a href="contact.php?lang=<?= $lang ?>" class="btn btn-outline-white btn-lg">
    ...
    <section class="section services-section">
        <div class="container">
            ...
            <div class="services-grid">
                <a href="offers.php?cat=umrah&lang=<?= $lang ?>" class="service-card">
                ...
                <a href="offers.php?cat=tourism&lang=<?= $lang ?>" class="service-card">
                    <div class="service-icon">🌍</div>
                ...
                <a href="offers.php?cat=hotel&lang=<?= $lang ?>" class="service-card">
                    <div class="service-icon">🏨</div>
                ...
                <a href="offers.php?cat=flight&lang=<?= $lang ?>" class="service-card">
                ...
                <a href="offers.php?cat=visa&lang=<?= $lang ?>" class="service-card">
                    <div class="service-icon">📋</div>
                ...
                <a href="offers.php?cat=car&lang=<?= $lang ?>" class="service-card">
                    <div class="service-icon">🚗</div>
                ...
                <div class="offer-card" data-cat="umrah">
                    ...
                    <div class="offer-body">
                        ...
                        <div class="offer-footer">
                            ...
                            <a href="offer-detail.php?id=1&lang=<?= $lang ?>" class="btn btn-dark btn-sm"><?= htmlspecialchars($t['offer_book']) ?></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="offer-card" data-cat="tourism">
                    ...
                    <div class="offer-body">
                        ...
                        <div class="offer-footer">
                            ...
                            <a href="offer-detail.php?id=2&lang=<?= $lang ?>" class="btn btn-dark btn-sm"><?= htmlspecialchars($t['offer_book']) ?></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="offer-card" data-cat="umrah">
                    ...
                    <div class="offer-body">
                        ...
                        <div class="offer-footer">
                            ...
                            <a href="offer-detail.php?id=3&lang=<?= $lang ?>" class="btn btn-dark btn-sm"><?= htmlspecialchars($t['offer_book']) ?></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="offer-card" data-cat="visa">
                    ...
                    <div class="offer-body">
                        ...
                        <div class="offer-footer">
                            ...
                            <a href="offer-detail.php?id=4&lang=<?= $lang ?>" class="btn btn-dark btn-sm"><?= htmlspecialchars($t['offer_book']) ?></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="offer-card" data-cat="hotel">
                    ...
                    <div class="offer-body">
                        ...
                        <div class="offer-footer">
                            ...
                            <a href="offer-detail.php?id=5&lang=<?= $lang ?>" class="btn btn-dark btn-sm"><?= htmlspecialchars($t['offer_book']) ?></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="offer-card" data-cat="flight">
                    ...
                    <div class="offer-body">
                        ...
                        <div class="offer-footer">
                            ...
                            <a href="offer-detail.php?id=6&lang=<?= $lang ?>" class="btn btn-dark btn-sm"><?= htmlspecialchars($t['offer_book']) ?></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section" style="background:var(--bg-light);text-align:center;">
        <div class="container" style="max-width:700px;">
            ...
            <div style="display:flex;gap:16px;justify-content:center;flex-wrap:wrap;">
                <a href="../auth/register.php?lang=<?= $lang ?>" class="btn btn-primary btn-lg">
