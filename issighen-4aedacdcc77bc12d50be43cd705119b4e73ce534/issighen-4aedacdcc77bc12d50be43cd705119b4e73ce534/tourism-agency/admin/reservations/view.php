...
$statusLabel = $res['status']==='confirmed'?($lang==='ar'?'مؤكد':($lang==='fr'?'Confirmé':'Confirmed')):
              ($res['status']==='cancelled'?($lang==='ar'?'ملغى':($lang==='fr'?'Annulé':'Cancelled')):
              ($lang==='ar'?'قيد الانتظار':($lang==='fr'?'En attente':'Pending')));
?>
<!DOCTYPE html>
        ...
        <div class="admin-grid-2">
            ...
            <div>
                <div class="card" style="margin-bottom:20px;">
                    <div class="card-header"><h3><i class="fas fa-user" style="color:var(--gold);margin-<?= $dir==='rtl'?'left':'right' ?>:8px;"></i><?= $lang==='ar'?'بيانات العميل':($lang==='fr'?'Informations client':'Client Information') ?></h3></div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header"><h3><i class="fas fa-calendar-check" style="color:var(--gold);margin-<?= $dir==='rtl'?'left':'right' ?>:8px;"></i><?= $lang==='ar'?'تفاصيل الحجز':($lang==='fr'?'Détails réservation':'Booking Details') ?></h3></div>
                    <div class="card-body">
                        <div class="reservation-detail-grid">
                            <div class="detail-row">
            ...
            <div>
                <div class="card">
                    <div class="card-header"><h3><i class="fas fa-cogs" style="color:var(--gold);margin-<?= $dir==='rtl'?'left':'right' ?>:8px;"></i><?= $lang==='ar'?'إجراءات':($lang==='fr'?'Actions':'Actions') ?></h3></div>
                    <div class="card-body">
