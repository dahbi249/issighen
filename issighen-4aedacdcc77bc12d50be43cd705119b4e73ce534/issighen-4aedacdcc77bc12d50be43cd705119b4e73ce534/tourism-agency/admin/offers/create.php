            ...
            <div class="admin-grid-2">
                ...
                <div>
                    <div class="card" style="margin-bottom:20px;">
                        <div class="card-header"><h3><?= $lang==='ar'?'محتوى العرض':($lang==='fr'?'Contenu de l\'offre':'Offer Content') ?></h3></div>
                        <div class="card-body">
                    ...
                    <!-- Includes list -->
                    <div class="card">
                        <div class="card-header"><h3><?= $lang==='ar'?'ما يشمله العرض':($lang==='fr'?'Ce qui est inclus':'What\'s Included') ?></h3></div>
                        <div class="card-body">
                            <div class="form-group">
                ...
                <div>
                    <div class="card" style="margin-bottom:20px;">
                        <div class="card-header"><h3><?= $lang==='ar'?'إعدادات العرض':($lang==='fr'?'Paramètres':'Offer Settings') ?></h3></div>
                        <div class="card-body">
                            <div class="form-group">
                    ...
                    <!-- Image upload -->
                    <div class="card" style="margin-bottom:20px;">
                        <div class="card-header"><h3><?= $lang==='ar'?'صورة العرض':($lang==='fr'?'Image de l\'offre':'Offer Image') ?></h3></div>
                        <div class="card-body">
...
uploadArea?.addEventListener('dragover',function(e){ e.preventDefault(); this.style.borderColor='var(--gold)'; });
...
uploadArea?.addEventListener('drop',function(e){
    ...
    if (file && file.type.startsWith('image/')) {
        document.getElementById('offerImage').files = e.dataTransfer.files;
        var reader = new FileReader();
