...
$offers = [
    1 => ['cat'=>'umrah','emoji'=>'🕌','price'=>85000,'days'=>10,'loc'=>'Makkah',
          'title_ar'=>'برنامج العمرة المميز','title_fr'=>'Programme Omra Premium','title_en'=>'Premium Umrah Package',
...
<div class="container">
    <div class="offer-detail-layout">
        ...
        <div>
            ...
            <!-- Includes -->
            <div class="card">
                <div class="card-header"><h3><?= htmlspecialchars($t['offer_includes']) ?></h3></div>
                <div class="card-body">
        ...
        <div id="book">
            ...
            <!-- Booking form -->
            <div class="card">
                <div class="card-header"><h3><?= htmlspecialchars($t['booking_title']) ?></h3></div>
                <div class="card-body">
